...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default="korean-Sexual-harassment", type=str, help="The name of the task to train")

    parser.add_argument("--model_dir", default="./trainModel/", type=str, help="Path to save, load model")
